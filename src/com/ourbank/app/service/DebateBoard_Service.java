...
public class DebateBoard_Service {
	@Autowired
	private DebateBoard_Mapper boardMapper;
	...
	//회원가입 arraylist
	public ArrayList<DebateBoard_Bean> getSignUpList(int nStartPage, int list_num){
	...
	//예적금 arraylist
	public ArrayList<DebateBoard_Bean> getSavingsList(int nStartPage, int list_num){
	...
	//기타 arraylist
	public ArrayList<DebateBoard_Bean> getEtcList(int nStartPage, int list_num){
		return this.boardMapper.getEtcList(nStartPage, list_num);
	}
	
	//글보기에 뿌릴 bean
	public DebateBoard_Bean getSpecificRow(int idx) {
