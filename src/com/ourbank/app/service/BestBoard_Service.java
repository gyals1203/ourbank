...
public class BestBoard_Service {
	@Autowired
	private BestBoard_Mapper boardMapper;
	
	//글입력 처리
	public void insertBoard(BestBoard_Bean boardBean) {
	...
	//회원가입 arraylist
	public ArrayList<BestBoard_Bean> getSignUpList(int nStartPage, int list_num){
	...
	//예적금 arraylist
	public ArrayList<BestBoard_Bean> getSavingsList(int nStartPage, int list_num){
	...
	//기타 arraylist
	public ArrayList<BestBoard_Bean> getEtcList(int nStartPage, int list_num){
		return this.boardMapper.getEtcList(nStartPage, list_num);
	}
	
	//글보기에 뿌릴 bean
	public BestBoard_Bean getSpecificRow(int idx) {
	...
	//글 수정하기
	public void updateBoard(BestBoard_Bean boardBean) {
	...
	//검색하기 => ArrayList 로 목록 
	public ArrayList<BestBoard_Bean> getSearchedList(int nStartPage, int list_num, String strSearchThis){
